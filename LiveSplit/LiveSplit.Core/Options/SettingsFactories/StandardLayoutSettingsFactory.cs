    ...
    public class StandardLayoutSettingsFactory : ILayoutSettingsFactory
    {
        public LayoutSettings Create()
        {
            return new LayoutSettings()
            {
                ...
                DynamicBackgroundTime = false,
                DynamicBackgroundKey = false,
                DynamicBackgroundSplit = false,
                DynamicBackgroundRandom = true,
                DynamicBackgroundSequence = false,
                TimeBetweenBackgroundChange = "5",
                UnitForTimeBetweenBackgroundChange = "Seconds",
                AlwaysOnTop = true,
                AntiAliasing = true,
                DropShadows = true,
                BackgroundType = BackgroundType.SolidColor,
                BackgroundImage = null,
                BackgroundImageFolder = null,
                ImageOpacity = 1f,
                ImageBlur = 0f,
                Opacity = 1,
